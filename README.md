...
# The Hospital-Defender project

<!-- Remove the parantheses in the title header for better readability !-->
  
![SwissFlagJButton.png This image failed to load. It may be due to the file not being reached, or a general error. Reload the page to fix a possible general error.](/SwissFlagJButton.png)

# By:

<!-- ![{Developer name} This image failed to load. It may be due to the file not being reached, or a general error. Reload the page to fix a possible general error.](/Image2.svg) !-->

## [Seanpm2001](https://github.com/seanpm2001/) / [Hospital-Defender](https://github.com/Hospital-Defender), [Seanwallawalla-health](https://github.com/Seanwallawalla-health/), [Seanpm2001-health](https://github.com/Seanpm2001-health/), Et; Al.
...
[Sorting options unavailable](https://github.com/Hospital-Defender/Hospital-Defender.github.io/)
...
Translations in languages other than English are machine translated and are not yet accurate. No errors have been fixed yet as of March 21st 2021. Please report translation errors [here](https://github.com/seanpm2001/Hospital-Defender/issues/). Make sure to backup your correction with sources and guide me, as I don't know languages other than English well (I plan on getting a translator eventually) please cite [wiktionary](https://en.wiktionary.org) and other sources in your report. Failing to do so will result in a rejection of the correction being published.
...
> [00.1 - Title](#The-Hospital-Defender-project)

> [00.2 - Read this article in a different language](#Read-this-article-in-a-different-language)

> [00.3 - Index](#Index)

[01.0 - Description](#Hospital-Defender)
...
See above. This project is a software tool aimed to assist hospitals with protection against digital attacks (cyber attacks) by blocking malware, spyware, and ransomware. This project is not a variant of [Linux defender](https://github.com/seanpm2001/Linux_Defender/), but it uses its libraries for identification.

One of this projects extra goals is advocacy for increasing the penalty of attacking hospitals, making it comparable to a very high level crime to prevent people from even trying. This goal is a long ways from fruition.
...
This project was started on 2021, Sunday, February 27th at 3:54 pm to help hospitals defend against malware.

### Alpha history

This project laid abandoned for a long time. On 2021 May 19th, this project received its own organization.

On 2021 September 7th, plans were prepared for getting the project up to date, in accordance with my medical software improvement pledge for the month of 2021 September. On 2021 September 8th, this project was brought up to date, with new documentation, new files, and its own website.

Also on this day, the description of the project was changed to the V2 description.
...
[Click/tap here to view this projects Wiki](https://github.com/Hospital-Defender/Hospital-Defender/wiki/)
...
> * 1. [seanpm2001](https://github.com/seanpm2001/) - 44 commits (As of 2021, Wednesday, September 8th at 6:58 pm)
...
[View the organization for this project](https://github.com/Hospital-Defender/)

[Build/view the makefile for this project](/makefile.mk)

[Join the discussion on GitHub](https://github.com/Hospital-Defender/Hospital-Defender/discussions/)

[View the issues/Raise an issue for this project](https://github.com/Hospital-Defender/Hospital-Defender/issues/)
...
**File version:** `1 (Wednesday, 2021, September 8th at 6:58 pm)`
...
Version 1 (2021, Wednesday, September 8th at 6:58 pm)
